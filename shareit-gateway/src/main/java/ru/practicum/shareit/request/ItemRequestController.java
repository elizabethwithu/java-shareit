...
public class ItemRequestController {
    ...
    @GetMapping
    public ResponseEntity<Object> findAllWithReplies(@RequestHeader("X-Sharer-User-Id") Long userId) {
    ...
    public ResponseEntity<Object> findByIdWithReplies(@RequestHeader("X-Sharer-User-Id") Long userId,
